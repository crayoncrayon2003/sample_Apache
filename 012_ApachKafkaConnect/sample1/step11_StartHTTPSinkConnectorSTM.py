...
def main():
    ...
    custom_sink_config = {
        ...
        "config": {
            ...
            # "transforms.ExtractData.field": "key1"
            "transforms": "RenameAndRemoveField",
            "transforms.RenameAndRemoveField.type": "org.apache.kafka.connect.transforms.ReplaceField$Value",
            "transforms.RenameAndRemoveField.renames": "key2:masked_key2",
            "transforms.RenameAndRemoveField.blacklist": "key1"
        }
    }
