...
#      --packages graphframes:graphframes:0.8.4-spark3.5-s_2.12 032_highway_analysis.py
# =============================================================
import os
import sys
...
spark = SparkSession.builder.master("local[*]").appName("HighwayGraphAnalysis").getOrCreate()
