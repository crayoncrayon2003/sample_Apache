...
#      --packages graphframes:graphframes:0.8.4-spark3.5-s_2.12 112_road_analysis.py
# =============================================================
import os
import sys
...
spark = SparkSession.builder.master("local[*]").appName("RoadMeshGraphAnalysis").getOrCreate()
