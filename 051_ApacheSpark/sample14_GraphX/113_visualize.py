...
#  ※ 先に 112_road_analysis.py を spark-submit で実行して vertex_metrics.csv を作っておくこと。
# =============================================================
import os
import sys
import math
...
def main():
    ...
    if not os.path.exists(METRICS_CSV):
        sys.exit(
            "分析結果 {0} が見つかりません。\n"
            "先に  spark-submit --packages graphframes:... 112_road_analysis.py  を実行してください。".format(METRICS_CSV)
        )
